  ...
  return (
    <div className="w-full max-w-md p-8 relative shadow-2xl animate-scale-in border-t-4 border-black bg-[#FDFBF7]">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          className="w-full bg-black text-white py-4 font-body text-xs uppercase tracking-[0.2em] hover:bg-stone-800 transition-colors mt-4 animate-fade-in-up delay-300"
        >
          Sign In
        </button>
      </form>

      <div className="mt-6 flex flex-col items-center gap-4 animate-fade-in-up delay-300">
        <div className="relative w-full flex items-center justify-center">
          <div className="border-t border-stone-200 w-full absolute"></div>
          <span className="bg-[#FDFBF7] px-4 font-body text-[10px] uppercase tracking-widest text-stone-400 relative">
            Or
          </span>
        </div>
      ...
      <div className="mt-6 text-center animate-fade-in-up delay-300">
        <Link
          to="/signup"
          className="font-body text-xs text-stone-500 hover:text-black border-b border-transparent hover:border-black pb-0.5 transition-all"
        >
